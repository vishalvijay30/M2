 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Vishal Vijayakumar");
		  toPrint += p1.toString("vvijayakumar8");
		  ...
		  Person3 p3 = new Person3("Gahan Wang");
		  toPrint += p3.toString("gwang307");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Swati Sharma");
          toPrint += p4.toString("ssharma95");
          //Person5 replace P5 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Robert Adams");
          toPrint += p5.toString("radams71");
          //Person6 replace P6 with your name
          //and gburdell6 with your gt id
          Person6 p6 = new Person6("Shaun Chapman");
          toPrint += p6.toString("schapman30");
